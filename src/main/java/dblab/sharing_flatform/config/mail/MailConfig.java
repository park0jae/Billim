...
public class MailConfig {
    ...
    public JavaMailSender NaverMailService(){
        ...
        javaMailSender.setUsername("zerozae0926"); // 네이버 아이디
        javaMailSender.setPassword("zerozae0926!"); // 네이버 비밀번호
    ...
    private Properties getMailProperties(){
        ...
        properties.setProperty("mail.smtp.starttls.enable", "true"); // smtp strattls 사용
